...
function ResourceCard({ item, index, inView }) {
  return (
    <motion.a
      ...
      className="flex items-center justify-between p-4 rounded-xl bg-cyber-dark/30 border border-cyber-border/30 hover:border-cyber-cyan/20 transition-all duration-300 group"
    >
      <div>
